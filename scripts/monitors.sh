...
MSI_HOME_MONITOR="HDMI-1-0 3840/879x1600/366"
...
if echo "$CONNECTED_MONITORS" | grep -q "$DELL_HOME_MONITOR"; then
    ...
    xrandr --output eDP-1 --mode 1920x1080 --pos 0x0 --rotate normal --output HDMI-1-0 --mode 3840x1600 --pos 1920x660 --rotate normal
else
